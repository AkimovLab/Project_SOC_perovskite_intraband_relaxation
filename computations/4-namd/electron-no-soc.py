...
rt = "/home/eric/SOC-Intraband/no-soc-pyxaid2/res/" 
...
params["namdtime"] = 2800                      # Trajectory time, fs
...
params["active_space"] = range(37,57) 

params["states"] = []
params["states"].append(["GS",[37,-37],0.00]) 
params["states"].append(["S1",[37,-38],0.00])  
params["states"].append(["S2",[37,-39],0.00])  
params["states"].append(["S3",[37,-40],0.00])  
params["states"].append(["S4",[37,-41],0.00])  
params["states"].append(["S5",[37,-42],0.00])  
params["states"].append(["S6",[37,-43],0.00])  
params["states"].append(["S7",[37,-44],0.00])  
params["states"].append(["S8",[37,-45],0.00])  
params["states"].append(["S9",[37,-46],0.00])  
params["states"].append(["S10",[37,-47],0.00])  
params["states"].append(["S11",[37,-48],0.00])  
params["states"].append(["S12",[37,-49],0.00])  
params["states"].append(["S13",[37,-50],0.00])  
params["states"].append(["S14",[37,-51],0.00])  
params["states"].append(["S15",[37,-52],0.00])  
params["states"].append(["S16",[37,-53],0.00])  
params["states"].append(["S17",[37,-54],0.00])  
params["states"].append(["S18",[37,-55],0.00])  
params["states"].append(["S19",[37,-56],0.00])  
